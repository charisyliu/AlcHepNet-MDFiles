...
|---|---|---|---|---|---|---|---|---|
| `alchepnet 01 version 3 clean protocol 3 9 21_updated.md` | protocol KB | OBS | study design, population, procedures, concepts, timing | official OBS study meaning as represented in KB/source | actual field existence/population | V3 2021-03-09 | 2026-08-27 | repository path available; pinned commit URL not supplied here |
| `CLEAN AHN RCT Protocol Amendment 5 v2.md` | protocol KB | RCT | design, treatment, eligibility, endpoints, timing | RCT protocol rules | actual released encoding | V6 Amendment 5 2022-01-25 | 2026-08-27 | repository path available; pinned commit URL not supplied here |
| `AlcHepNet_Biorepository_MOP_v2.0 10-2021 (004)_updated.md` | MOP KB | biospecimen operations | collection, processing, labeling, storage, shipping | MOP procedures | study-specific requirement unless protocol agrees; actual availability | V2.0 2021-10-25 | 2026-08-27 | repository path available; pinned commit URL not supplied here |
| `ARDaC_Training_Comprehensive_Notes.md` | training | portal/workflow | portal and training workflow | documented training workflow | official protocol meaning or physical availability | working training KB | 2026-08-27 | library/repository path; pinned link not supplied |
| `schema.json` | data dictionary/schema | DD 2.1.1 | entities, properties, types, enums, links | schema names/relationships | clinical intent or actual completeness | 2.1.1 | 2026-08-27 | supplied `dd/schema.json` |
| `Physical_Data_KB_generated.md` | generated physical profile | supplied v2-1-0 TSV scope | actual rows, columns, encodings, missingness, distributions, link checks | what is physically present in supplied scope | clinical definitions or protocol rules | generated 2026-08-27 | 2026-08-27 | generated artifact |
| prior evaluation files | QA | OBS/RCT/MOP | representative questions and identified gaps | QA evidence about KB coverage | cannot override primary source | 2026-08-05 | 2026-08-27 | library files |
...
| GAP-002 | pinned commit URLs for every umbrella source | umbrella source register | library/repository filenames | exact commit addresses not available in supplied materials | add repository + commit addresses | open | 2026-08-27 |

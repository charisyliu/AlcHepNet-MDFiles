...
**Original-source repository snapshot:** [`f209bdf5cebc7ed4758329bff075403c58718be7`](https://github.com/charisyliu/AlcHepNet-MDFiles/tree/f209bdf5cebc7ed4758329bff075403c58718be7)  
**ITAALD repository snapshot:** [`421970feec8607083a575cd5a3b8286218520c53`](https://github.com/charisyliu/AlcHepNet-MDFiles/tree/421970feec8607083a575cd5a3b8286218520c53)  
**Repository:** `charisyliu/AlcHepNet-MDFiles`  
All GitHub links below are pinned to the applicable commit and will not change when the `main` branch changes.
...
| `ITAALD_Protocol_KB.md` | protocol KB | ITAALD | design, population, interventions, visits, endpoint definitions, safety, specimen schedule | official ITAALD study meaning and conduct represented in signed Protocol V2 | formal analysis rules when the SAP is more specific; actual released encoding | Protocol V2; 2025-05-22; signed 2025-07-23 | 2026-09-17 | [Pinned source](https://github.com/charisyliu/AlcHepNet-MDFiles/blob/421970feec8607083a575cd5a3b8286218520c53/ITAALD_Protocol_KB.md) |
| `ITAALD_SAP_KB.md` | SAP KB | ITAALD | analysis populations, models, multiplicity, interim analysis, missing data, safety analysis | prespecified ITAALD statistical-analysis rules represented in SAP V1.0 | study conduct, actual released encoding, unresolved SAP ambiguities | SAP V1.0; 2025-03-31 | 2026-09-17 | [Pinned source](https://github.com/charisyliu/AlcHepNet-MDFiles/blob/421970feec8607083a575cd5a3b8286218520c53/ITAALD_SAP_KB.md) |
...
| GAP-009 | repository-pinned links for ITAALD KBs | new ITAALD integration | ITAALD KBs at commit `421970feec8607083a575cd5a3b8286218520c53` | resolved for both generated ITAALD KBs; original PDF/DOCX source documents are not stored in the repository | preserve pinned KB links; add separately versioned source-document links only if the originals are later published | resolved for KB sources | 2026-09-17 |
